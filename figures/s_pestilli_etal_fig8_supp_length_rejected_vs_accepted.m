function s_pestilli_etal_fig8_supp_length_rejected_vs_accepted(whichSubject)
%
...
for isbj = whichSubject
    ...
    wbOptimizedFG    = dir(fullfile(whole_brain_fiber_group,'*optimized*.mat'));
    wbNotOptimizedFG = dir(fullfile(whole_brain_fiber_group,'*0000.pdb'));
    ...
    for iWB = 1:length(wbFG)
        ...
        res = dir(fullfile(results_dir,sprintf('*%s*.mat',wbOptimizedFG(iWB).name(1:60))));
