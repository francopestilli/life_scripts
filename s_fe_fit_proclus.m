function fe = s_fe_fit_proclus(subjects2run,bval)
%
% This function:
...
if strcmpi(deblank(evalc('!hostname')),'marcovaldo') || ...
   strcmpi(deblank(evalc('!hostname')),'predator.stanford.edu')
    datapath = '/home/frk/2t1/predator';
elseif   strcmpi(deblank(evalc('!hostname')),'celadon')
    datapath = '/marcovaldo/frk/2t1/predator';
else
    datapath = '/hsgs/projects/wandell/frk/life';
end
fprintf('\n datapath: %s \n',datapath)
subjects = {'KK_96dirs_b2000_1p5iso', ...    
