function s_ms_display_dsig_rmse_fig3_6(trackingType,lmax,bval,rep,volume)
%
...
for isl = 1:length(slices)
    for idir = 1:length(dirs)
        ...
        dSigImgB1(1,1,1,volume(end)) = 300;
        dSigImgB1(1,2,1,volume(end)) = -300;
        ...
        dSigImgB2(1,1,1,volume(end)) = 300;
        dSigImgB2(1,2,1,volume(end)) = -300;
        ...
        pSigImgB(1,1,1,volume(end)) = 300;
        pSigImgB(1,2,1,volume(end)) = -300;
